...
public sealed class ResolvePetReportCommandHandler
    : IRequestHandler<ResolvePetReportCommand, Result>
{
    private readonly IPetReportRepository _petReportRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ICurrentUserService _currentUserService;

    public ResolvePetReportCommandHandler(
    ...
    public async Task<Result> Handle(
        ResolvePetReportCommand request,
