...
public sealed class ConfirmPetReportMatchCommandHandler
    : IRequestHandler<ConfirmPetReportMatchCommand, Result>
{
    ...
    public ConfirmPetReportMatchCommandHandler(
    ...
    public async Task<Result> Handle(
        ConfirmPetReportMatchCommand request,
